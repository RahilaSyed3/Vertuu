report 60003 "Dynamo Sales - Credit Memo"
{

    Caption = 'Dynamo - Credit Memo';
    DefaultRenderingLayout = DynamoLayout;
    ...
    dataset
    {
        dataitem(Header; "Sales Cr.Memo Header")
        {
            ...
            begin
                // Dynamo >>
                CalcFields("Net Amt. Authorized (LCY) -CL-");
                // Dynamo <<
                FirstLineHasBeenOutput := false;
            end;
        }
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            Caption = 'Dynamo Sales - Credit Memo';
            LayoutFile = '.\src\reports\Layouts\DynamoSalesCrMemo.rdlc';
        }
    }
    ...
    var
        ...
        SalesCreditMemoNoLbl: Label 'Sales - Credit Memo %1', Comment = '%1 is replaced with Copy';
        ...
        PageLbl: Label 'Page %1/%2', Comment = '%1 is replaced with page No and %2 is replaced with Total Pages';
