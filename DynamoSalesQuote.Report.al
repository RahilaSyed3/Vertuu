report 60004 "Dynamo Sales - Quote"
{

    Caption = 'Dynamo Sales - Quote';
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            { }
            column(Net_Amount_to_Auth___LCY___CL_; "Net Amt. Authorized (LCY) -CL-")
            { }
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                column(ItemPicture_Line; Item.Picture)
                {

                }
                column(ItemSize; Item."PRODUCT SIZE")
                { }
    ...
    rendering
    {
        layout(DynamoLayout)
        {
            Caption = 'Dynamo Sales Quote';
            Type = RDLC;
            LayoutFile = 'src\reports\Layouts\DynamoSalesQuote.rdlc';
        }
    }
